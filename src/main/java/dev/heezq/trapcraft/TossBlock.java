 ...
 */
public class TossBlock extends Block implements PolymerBlock, PolymerTexturedBlock {
    ...
    public TossBlock(Settings settings) {
        ...
        for (Direction facing : Direction.Type.HORIZONTAL) {
            carriers.put(facing, TrapPolymer.requestOrFallback(
                ...
                PolymerBlockModel.of(Identifier.of("trapcraft:block/toss"),
                                0, spin(facing)),
                () -> Blocks.GREEN_TERRACOTTA.getDefaultState(), "toss facing " + facing.asString()));
        }
